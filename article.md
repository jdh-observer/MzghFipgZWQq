...
- Last but not least, we switched from a double-blind to a single-blind peer review process. The double-blind peer review process led to the existence of competing versions of the articles, one stored on the authors' GitHub repository, and the other one on the JDH's GitHub account. This added huge complexity to the anonymisation process - especially when dealing with different versions of the article (due to revisions required by the reviewers).
